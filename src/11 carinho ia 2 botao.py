...
def audio_capture_thread():
    ...
    while True:
        if keyboard.is_pressed('g') and not is_recording:
            ...
            is_recording = False
            print("[GRAVANDO] Processando inferencia...")
...
def main():
    ...
    pygame.display.set_caption("Robo - Modelo de Atencao 1D Hibrido por Botao 'G'")
    ...
    while running:
        ...
        if is_recording or keyboard.is_pressed('g'):
            ...
            estado_atual_nome = "GRAVANDO AUDIO (CARRINHO PARADO)..."
        else:
        ...
        if is_recording or keyboard.is_pressed('g'):
            ...
            lbl_grav = font_bold.render("SOLTE 'G' E FALE IMEDIATAMENTE (1.5 SEGUNDOS DE GRAVACAO)...", True, (255, 50, 50))
